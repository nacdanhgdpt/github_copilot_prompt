---
description: Nguyên tắc phát triển của Linus Torvalds - Nền tảng cho tất cả agents
...
- ✅ Tất cả code implementation
- ✅ Tất cả architectural decisions
- ✅ Tất cả technical designs
- ✅ Tất cả requirements specifications
- ✅ Tất cả interactions với người dùng

## Khi nào Principles được áp dụng

**Luôn luôn.** Không có ngoại lệ.

Mỗi agent khác (@create-spec, @design, @execute-task, etc.) đều tuân theo các nguyên tắc này như nền tảng.
